...
public class Clientes extends JDialog {
	...
	private void adicionarCliente() {
		if (txtNome.getText().isEmpty()) {
			...
			JOptionPane.showMessageDialog(null, "preencha o campo Cidade", "Aten��o P�", JOptionPane.ERROR_MESSAGE);
			txtCidade.requestFocus();
		} else if (cboUf.getSelectedItem().toString().isEmpty()) {
			JOptionPane.showMessageDialog(null, "preencha o campo UF", "Aten��o P�", JOptionPane.ERROR_MESSAGE);
			cboUf.requestFocus();
			...
			try {
				...
				JOptionPane.showMessageDialog(null, "Email ja cadastrado", "Aten��o ", JOptionPane.ERROR_MESSAGE);
	...
	private void editarCliente() {
		if (txtNome.getText().isEmpty()) {
			...
			JOptionPane.showMessageDialog(null, "preencha o campo ", "Aten��o P�", JOptionPane.ERROR_MESSAGE);
			txtCidade.requestFocus();
		} else if (cboUf.getSelectedItem().toString().isEmpty()) {
			JOptionPane.showMessageDialog(null, "preencha o campo UF", "Aten��o P�", JOptionPane.ERROR_MESSAGE);
			cboUf.requestFocus();
	...
	private void excluirCliente() {
		// confirma�ao de exclus�o
		int confirma = JOptionPane.showConfirmDialog(null, "Tem certeza que deseja excluir esse cliente??", "Aten��o!",
