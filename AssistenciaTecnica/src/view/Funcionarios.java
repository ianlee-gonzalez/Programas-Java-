...
public class Funcionarios extends JDialog {
	...
	private void adicionarFuncionario() {
		if (txtUsuario.getText().isEmpty()) {
			...
			JOptionPane.showMessageDialog(null, "preencha o campo Login", "Atenção Po", JOptionPane.ERROR_MESSAGE);
			txtLogin.requestFocus();
		} else if (txtSenha.getText().isEmpty()) {
			JOptionPane.showMessageDialog(null, "preencha o campo Senha", "Atençao P�", JOptionPane.ERROR_MESSAGE);
	...
	private void editarFuncionario() {
		if (txtUsuario.getText().isEmpty()) {
			JOptionPane.showMessageDialog(null, "preencha o campo Usuario", "Atençao P�", JOptionPane.ERROR_MESSAGE);
			txtUsuario.requestFocus();
